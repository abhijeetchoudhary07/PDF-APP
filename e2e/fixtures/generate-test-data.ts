...
async function generateAllTestData() {
  ...
  // 2. scanned.pdf - 1 page with simulated scanned page (draw a rectangle simulating image)
  ...
  // Add minimal vector text or leave image-only
  ...
  // Helper to create a minimal 1x1 or NxN JPEG buffer
  // We can write a simple valid JPEG structure
  // A standard minimal 1x1 JPEG:
  ...
  // Generate valid-photo.jpg (~35 KB by padding)
  ...
  // Generate oversized-photo.jpg (> 100 KB)
  ...
  // Generate small-photo.jpg (< 10 KB)
  ...
  // Generate wrong-ratio.jpg, wrong-dimensions.jpg
